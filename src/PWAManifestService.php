...
{
    public static function get(?PWA $tenant = null): array
    {
    ...
    private static function generate(?PWA $tenant = null): array
    {
        $pwa = $tenant?->pwa;
        ...
        $basicManifest = [
            ...
            'description' => $pwa?->description ?? config('pwa.manifest.description'),
            ...
            'screenshots' => $pwa?->splash ?? config('pwa.manifest.screenshots'),
